...
class Ball(GameObject):
    def __init__(self, canvas, x, y, effect="fire"):
        ...
        item = canvas.create_oval(x - self.radius, y - self.radius,
                                  ...
                                  fill='yellow')  # Changed ball color to yellow
    ...
    def add_effect(self, coords):
        ...
        if self.effect == "fire":
            # Create fire effect
            flame = self.canvas.create_oval(x - 2, y - 2, x + 2, y + 2, fill="red", outline="")  # Changed flame color to red
...
class Paddle(GameObject):
    def __init__(self, canvas, x, y):
        ...
        item = canvas.create_rectangle(x - self.width / 2,
                                       ...
                                       x + self.width / 2,
                                       y + self.height / 2,
                                       fill='#4CAF50')  # Changed paddle color to green
...
class Brick(GameObject):
    COLORS = {1: '#FF5722', 2: '#FFC107', 3: '#3F51B5'}  # Changed brick colors
...
class Game(tk.Frame):
    LEVEL_COLORS = ['#D1C4E9', '#BBDEFB', '#FFE082', '#E6EE9C', '#C8E6C9']  # Changed level colors
    ...
    def draw_text(self, x, y, text, size='40'):
        font = ('Arial', size)  # Changed font to Arial
